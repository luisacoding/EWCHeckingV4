...
public class PurchaseLineTotalServlet extends HttpServlet {
	...
	//public static void main(String[] args) {	
		...
		String sql ="SELECT spurno,count(spurno) total FROM purdec WHERE spurno > 'G1505230000' GROUP BY spurno";
