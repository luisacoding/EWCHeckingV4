...
public class TestDB {
	public static void main(String[] args) {
			...
			for (int j = 0; j < list.size(); j++) {
				...
				if (erpTemp.getItemno().equals(wmsTemp.getItemno())) {
					...
					if (erpTemp.getQuantity() != wmsTemp.getQuantity()) {
							float difference = erpTemp.getQuantity() - wmsTemp.getQuantity();
        ...
        for(int i=0; i < WMSunequalList.size(); i++){
        	...
        	ERPInventory jsonList = WMSunequalList.get(i);
